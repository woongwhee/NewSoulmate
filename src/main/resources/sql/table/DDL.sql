...
(
    "TYPE_NO"    NUMBER
        CONSTRAINT BT_TC_PK PRIMARY KEY,
...
(
    ...
    CATEGORY_NO    NUMBER
        CONSTRAINT RT_CN_NN NOT NULL,
    REF_TYPE       NUMBER
        CONSTRAINT RT_RT_NN NOT NULL
        CONSTRAINT RT_RT_CK CHECK ( REF_TYPE IN (0, 1, 2)),
    REF_NO         NUMBER
        CONSTRAINT RT_RN_NN NOT NULL,
...
(
    "GRADE_NO"         NUMBER
        CONSTRAINT "PK_GRADE_UP" PRIMARY KEY,
    "MEMBER_NO"        NUMBER
        CONSTRAINT "GU_MN_NN" NOT NULL,
    "SHELTER_NO"       NUMBER
        CONSTRAINT "GU_SN_NN" NOT NULL,
    "FILE_PATH"        VARCHAR(200)
        CONSTRAINT "GU_FP_NN" NOT NULL,
    "SHELTER_TEL"      VARCHAR2(20)
        CONSTRAINT "GU_ST_NN" NOT NULL,
    "SHELTER_LANDLINE" VARCHAR2(20)
        CONSTRAINT "GU_SL_NN" NOT NULL,
    "SHELTER_COMP_NO"  VARCHAR2(30)
        CONSTRAINT "GU_SCN_NN" NOT NULL,
    "GRADE_STATUS"     VARCHAR2(1)
        CONSTRAINT "GU_GS_NN" NOT NULL,
    "SHELTER_ADDRESS"  VARCHAR2(100)
        CONSTRAINT "GU_SA_NN" NULL
);
...
ALTER TABLE VOLUNTEER
    ADD CONSTRAINT VL_SN_FK FOREIGN KEY (SHELTER_NO)
        REFERENCES SHELTER (SHELTER_NO) ON DELETE SET NULL;
ALTER TABLE VOLUNTEER
    ADD CONSTRAINT VL_MN_FK FOREIGN KEY (MEMBER_NO)
        REFERENCES MEMBER (MEMBER_NO) ON DELETE SET NULL;

ALTER TABLE "BOARD"
    ADD CONSTRAINT BD_MN_FK FOREIGN KEY (MEMBER_NO)
        REFERENCES "MEMBER" ("MEMBER_NO") on delete SET NULL;
ALTER TABLE "BOARD"
    ADD CONSTRAINT BD_BT_FK FOREIGN KEY ("TYPE_NO")
        REFERENCES "BOARD_TYPE" ("TYPE_NO");
ALTER TABLE "BOARD"
    ADD CONSTRAINT BD_RN_FK FOREIGN KEY ("CATEGORY_NO")
        REFERENCES CATEGORY (CATEGORY_NO);

ALTER TABLE "SUPPORT"
    ADD CONSTRAINT SP_SN_FK FOREIGN KEY ("SHELTER_NO")
        REFERENCES "SHELTER" ("SHELTER_NO");
ALTER TABLE "SUPPORT"
    ADD CONSTRAINT "SP_MN_FK" FOREIGN KEY ("MEMBER_NO")
        REFERENCES "MEMBER" ("MEMBER_NO");

ALTER TABLE "CONFIRM"
    ADD CONSTRAINT "CF_MN_FK" FOREIGN KEY ("MEMBER_NO")
        REFERENCES "MEMBER" ("MEMBER_NO");

ALTER TABLE "SUBSCRIPTION"
    ADD CONSTRAINT "SUB_MN_FK" FOREIGN KEY ("MEMBER_NO")
        REFERENCES "MEMBER" ("MEMBER_NO");
ALTER TABLE "SUBSCRIPTION"
    ADD CONSTRAINT "SUB_SN_FK" FOREIGN KEY ("SHELTER_NO")
        REFERENCES "SHELTER" ("SHELTER_NO");

ALTER TABLE REPLY
    ADD CONSTRAINT "CM_BN_FK" FOREIGN KEY ("BOARD_NO")
        REFERENCES "BOARD" ("BOARD_NO");
ALTER TABLE REPLY
    ADD CONSTRAINT "CM_MN_FK" FOREIGN KEY ("MEMBER_NO")
        REFERENCES "MEMBER" (MEMBER_NO);

ALTER TABLE "MESSAGE"
    ADD CONSTRAINT "MS_MN_FK" FOREIGN KEY ("MEMBER_NO")
        REFERENCES "MEMBER" ("MEMBER_NO");
ALTER TABLE "MESSAGE"
    ADD CONSTRAINT "MS_SN_FK" FOREIGN KEY ("SHELTER_NO")
        REFERENCES "SHELTER" ("SHELTER_NO");

ALTER TABLE "SHELTER"
    ADD CONSTRAINT "ST_CN_FK" FOREIGN KEY ("CITY_NO")
        REFERENCES "CITY" ("CITY_NO");
ALTER TABLE "SHELTER"
    ADD CONSTRAINT "ST_VN_FK" FOREIGN KEY ("VILLAGE_NO")
        REFERENCES "VILLAGE" ("VILLAGE_NO");

ALTER TABLE "VILLAGE"
    ADD CONSTRAINT "VG_CN_FK" FOREIGN KEY ("VILLAGE_NO")
        REFERENCES "VILLAGE" ("VILLAGE_NO");

ALTER TABLE "GRADE_UP"
    ADD CONSTRAINT "GU_MN_FK" FOREIGN KEY ("MEMBER_NO")
        REFERENCES "MEMBER" ("MEMBER_NO");
ALTER TABLE "GRADE_UP"
    ADD CONSTRAINT "FK_SHELTER_TO_GRADE_UP_1" FOREIGN KEY ("SHELTER_NO")
        REFERENCES "SHELTER" ("SHELTER_NO");
ALTER TABLE "REPORT"
    ADD CONSTRAINT "RT_CN_FK" FOREIGN KEY ("CATEGORY_NO")
        REFERENCES "CATEGORY" ("CATEGORY_NO");
-----TRIGGER-----------------------------
--회원탈퇴트리거
