...
@WebFilter(filterName = "loginFilter",
    servletNames = {
        "report","AdoptApplyController","InquireDetailController","MemberInfoDetailViewController","AdoptReviewEnrollController","adoptReInsert","/replyInsert.ad","replyInsert"
    }
)
